...
export default function ContributePage({ className = "" }: ContributePageProps) {
  ...
  const isFormValid = formData.name && formData.phoneNumber && formData.email && formData.religion && formData.amount
        ...
        <div className="container mx-auto px-6 max-w-2xl">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Your contribution form has been submitted successfully. Please check your email for further proceedings.
            </p>
            <Button
    ...
    <section className={`py-20 bg-gradient-to-b from-gray-50 to-white ${className}`}>
      <div className="container mx-auto px-6 max-w-2xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">Contribute</h1>
          <div className="w-24 h-1 bg-gradient-to-r from-orange-500 to-green-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-xl text-gray-600 leading-relaxed">
            Join our mission to build bridges between communities. Share your information to get involved in our
            interfaith initiatives and make a positive impact.
          </p>
        </div>
          ...
          <CardContent className="p-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="1"
                    step="1"
                    className="block w-full pl-8 pr-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
                    placeholder="Enter contribution amount"
                  />
                </div>
                <p className="text-xs text-gray-500 mt-1">
                  Your contribution helps us continue our interfaith initiatives and community programs.
                </p>
              </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-orange-50 to-green-50 rounded-2xl border border-orange-100">
              ...
              <ul className="text-gray-700 space-y-1 text-sm">
                ...
                <li>• Our team will review your contribution interest</li>
                <li>• We'll contact you with relevant opportunities</li>
                <li>• Join our community of interfaith advocates</li>
              </ul>
            </div>
          </CardContent>
        </Card>
